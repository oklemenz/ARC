//
//  DefenderCarVirtualObject.swift
//  ARC
//
...
class DefenderCarVirtualObject: CarVirtualObject {
    ...
    override func setup() {
        ...
        let box = SCNBox(width: 0.5, height: 0.25, length: 1.15, chamferRadius: 0)
        let boxShape = SCNPhysicsShape(geometry: box, options: [SCNPhysicsShape.Option.scale: SCNVector3(0.20, 0.20, 0.20)])
        let bodyShape = SCNPhysicsShape(shapes: [boxShape], transforms: [NSValue(scnMatrix4:SCNMatrix4MakeTranslation(0.0, 0.125 * 0.2, 0.0))])
